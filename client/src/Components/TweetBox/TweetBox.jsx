...
const TweetBox = () => {
    return (
        <div className="tweet-box">
            <div className="tweet-box-image">
                <a>
                    <div className="tweet-box-image-container">
                        <img alt="yasir tobbileh" draggable="true" src="https://abs.twimg.com/sticky/default_profile_images/default_profile_bigger.png" class="css-9pa8cd"></img>
                    </div>
                </a>
            </div>
            ...
            <div className="tweet-box-input">
                ...
                <div className="tweet-options">
                    <div>
                        ...
                        <div className="tweet-options-btn">
                            <a>Tweet</a>
                        </div>
                    </div>
                </div>
